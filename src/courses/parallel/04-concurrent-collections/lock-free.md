---
title: "Collections and nonblocking algorithms"
description: "Topic 4. Thread-safe collections: Collections and nonblocking algorithms"
outline: [2, 3]
sourceHash: "009a8c671e8a321bbb1b34a7aa24a37b4d54649dca0a0847058540fc65747453"
---

# Collections and nonblocking algorithms
...
sequenceDiagram
  ...
  participant D as shared<br>Dictionary
  ...
  P2->>D: Add("x", 1)
  D--xP2: exception
  Note over P1,P2: between the check and the action<br>another thread changed the dictionary:<br>exception or data loss
```
...
flowchart TB
  ...
  S --> OK["<b>success</b>: <code>head</code> equaled<br><code>old</code> and now points to <code>N</code>"]
  S --> RETRY["<b>retry</b>: another thread<br>changed <code>head</code>; read<br><code>head</code> again and retry"]
```
