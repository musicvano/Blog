...
flowchart LR
  ...
  subgraph OBJECTS["<b>Об’єкти: тип і значення</b>"]
    ...
    STR["<code>str</code><br><code>#quot;Київ#quot;</code>"]
  ...
  C --> FLT
  C -.->|"раніше"| STR
  N["Після <code>a = 42; b = a; c = #quot;Київ#quot;; c = 3.14</code><br>Пунктир: попередній зв’язок, який уже не діє."]
```
