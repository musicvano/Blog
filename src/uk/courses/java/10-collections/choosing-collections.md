...
::: info Знімок екрана
Зупиніть частотний приклад після заповнення counts. Покажіть ключі та значення у Variables, версію JDK і рядок зупинки. Внутрішні поля HashMap позначте деталями реалізації.
:::
