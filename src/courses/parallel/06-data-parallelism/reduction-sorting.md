...
outline: [2, 3]
sourceHash: "dbca9bf7f4f8fd3dbcb97e1def8a1f6e752ec7821c4e519afb500e39ac185a12"
---
...
flowchart BT
  ...
  c0 --- d0
  c1 --- d0
  NOTE["steps: log<sub>2</sub> <i>n</i> = 3; additions within a step run concurrently"] ~~~ a3
```
