---
title: "Tasks"
description: "Topic 1. Kotlin and your first program: task variants"
outline: [2, 3]
sourceHash: "c6d7d287fe704df94a8d3317c2725e016caf166065813c71e93291f3048933f0"
---
...
### Variant 2. Currency exchange {#v2}
...
### Variant 22. Gravitational force {#v22}
...
### Variant 23. Educational energy calculation {#v23}
...
1. Record Kotlin, Gradle, the build process JVM, and the program JDK.
2. Create a Kotlin DSL project and check mainClass and stdin.
3. Record the formula, units, valid values, and rounding.
4. Implement the program and compare the result with a manual calculation.
