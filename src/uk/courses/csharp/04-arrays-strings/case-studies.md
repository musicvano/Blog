...
string[] shops = ["Центр", "Лівобережний", "Інгулецький"];
...
Лівобережний      87,3    91,6   102,4    99,8    381,1
Інгулецький       64,0    70,5    68,9    81,2    284,6
...
| `"Київ" == "київ"` дає `False` | порівняння враховує регістр; `StringComparison.OrdinalIgnoreCase` |
