...
**1. Початковий рівень.** Створити сервіс розкладу потягів за шлюзом YARP у рішенні Aspire: `GET /api/trains?from=Київ&to=Львів` повертає потяги з часом відправлення й вільними місцями.
