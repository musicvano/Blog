...
4. [Deadlocks and the cost of synchronization](./deadlock) — Deadlock · Starvation, livelock, priority inversion, and lock convoys · Classic synchronization problems · The cost of synchronization
