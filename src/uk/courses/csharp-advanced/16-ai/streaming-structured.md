...
[
    "Продам велосипед Trek Marlin 5, рама M, стан добрий. " +
        "4 500 грн, торг. Київ, Оболонь.",
    "Здаю однокімнатну квартиру біля метро «Холодна гора», " +
        "Харків. 9000 на місяць + комунальні.",
    "Терміново!!! Дзвоніть!!!"
];
...
Sale      Велосипед Trek Marlin 5       4 500  Київ
Rent      Однокімнатна квартира         9 000  Харків
