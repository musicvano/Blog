...
Welcome to my digital space — a place for programming courses, tutorials, projects, and anything else I feel inspired to share. Here you'll find the courses I teach, my latest ideas, and the tutorials I've created over the years.
...
My interests are wide-ranging, and so is the content you'll find here:

- [Programming courses](/courses/): object-oriented programming in C++, C#, Java, Kotlin, and Python, Parallel and Distributed Computing.
- [Tutorials](/csharp/introduction) and articles on C# and other programming languages.
...
- Working full-time as an Associate Professor at the university and teaching programming.
