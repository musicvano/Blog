...
**1. Початковий рівень.** Створити програму-видавця, яка публікує в обмінник `weather` типу topic прогнози з ключами `<область>.<тип>` (наприклад, `kyiv.rain`), та програму-підписника, що отримує шаблон прив’язки з клавіатури й виводить відповідні прогнози.
...
**1. Початковий рівень.** Створити програму, яка публікує в обмінник topic події замовлень з ключами `<місто>.<статус>` (наприклад, `lviv.delivered`), та підписника, що отримує шаблон з клавіатури й виводить відповідні події.
