...
::: info Знімок екрана
У справжньому FXML покажіть Controller class, fx:id вибраного TextField та onAction кнопки; вони мають збігатися з опублікованим контролером.
:::
...
::: info Знімок екрана
Покажіть справжню таблицю з TableColumn та їх fx:id. Зіставте їх з полями контролера навчального проєкту.
:::
