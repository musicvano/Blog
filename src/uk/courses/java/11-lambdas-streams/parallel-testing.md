...
::: info Знімок екрана
У IntelliJ IDEA покажіть власний функціональний інтерфейс, анонімну реалізацію й доступну дію заміни. Код має бути з робочого навчального проєкту, а не намальованим макетом.
:::

Рис. 11.7. Перетворення анонімного класу на лямбду {.caption}

::: info Знімок екрана
Покажіть налагодження filter–map–limit у IntelliJ IDEA. Якщо версія IDE не має Stream Trace, використайте звичайні точки зупинки в лямбдах і явно підпишіть цей спосіб.
:::

Рис. 11.8. Спостереження за елементами конвеєра {.caption}
