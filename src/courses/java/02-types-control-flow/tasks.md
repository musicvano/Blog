...
outline: [2, 3]
sourceHash: "d539843367a82eec2571ef5b38456b94eea6059a5bc3e06429f3812079150c91"
---
...
### Variant 6. Multiplication table {#v6}
...
### Variant 10. Calendar intervals {#v10}
...
### Variant 11. Day of the week {#v11}
...
### Variant 12. Educational tax calculation {#v12}
...
### Variant 13. Hypothetical indicator zones {#v13}
...
### Variant 16. Digits of a number {#v16}
...
### Variant 17. Coffee vending machine {#v17}
...
### Variant 19. Pascal's triangle {#v19}
...
### Variant 20. Linear temperature scale {#v20}
...
### Variant 23. Deposit with contributions {#v23}
...
### Variant 25. Character shapes {#v25}
...
### Variant 26. Arithmetic trainer {#v26}
...
### Variant 27. Duration in seconds {#v27}
...
### Variant 28. Class bell schedule {#v28}
...
1. Record the ranges and format of the input data.
2. Choose types with room for intermediate results.
3. Implement format, bounds, and EOF checks.
4. Explain the termination condition for every loop.
