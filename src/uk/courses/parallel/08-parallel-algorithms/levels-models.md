...
**Зернистість** (*granularity*) визначалася в темі 1 як співвідношення обсягу обчислень у паралельній частині та обсягу взаємодії між частинами. Її оцінюють величиною

$$
G = \frac{T_{\text{обч}}}{T_{\text{взаємодії}}} ,
$$

де $T_{\text{обч}}$ – час обчислень частини, а $T_{\text{взаємодії}}$ – час обмінів, синхронізації та створення частини. Розрізняють:
